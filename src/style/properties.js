...
(function(){
  ...
  var props = styfn.properties = [
    ...
    { name: 'text-padding-left', type: t.size},
    { name: 'text-padding-right', type: t.size},
    { name: 'text-padding-top', type: t.size},
    { name: 'text-padding-bottom', type: t.size},
    { name: 'source-text-padding-left', type: t.size},
    { name: 'source-text-padding-right', type: t.size},
    { name: 'source-text-padding-top', type: t.size},
    { name: 'source-text-padding-bottom', type: t.size},
    { name: 'target-text-padding-left', type: t.size},
    { name: 'target-text-padding-right', type: t.size},
    { name: 'target-text-padding-top', type: t.size},
    { name: 'target-text-padding-bottom', type: t.size},
    { name: 'text-hide-border-left', type: t.bool},
    { name: 'text-hide-border-right', type: t.bool},
    { name: 'text-hide-border-top', type: t.bool},
    { name: 'text-hide-border-bottom', type: t.bool},
    { name: 'source-text-hide-border-left', type: t.bool},
    { name: 'source-text-hide-border-right', type: t.bool},
    { name: 'source-text-hide-border-top', type: t.bool},
    { name: 'source-text-hide-border-bottom', type: t.bool},
    { name: 'target-text-hide-border-left', type: t.bool},
    { name: 'target-text-hide-border-right', type: t.bool},
    { name: 'target-text-hide-border-top', type: t.bool},
    { name: 'target-text-hide-border-bottom', type: t.bool},
    // behaviour
...
styfn.getDefaultProperties = util.memoize( function(){
  var rawProps = util.extend( {
    ...
    'source-text-padding-left': 0,
    'source-text-padding-right': 0,
    'source-text-padding-top': 0,
    'source-text-padding-bottom': 0,
    'target-text-padding-left': 0,
    'target-text-padding-right': 0,
    'target-text-padding-top': 0,
    'target-text-padding-bottom': 0,
    'text-hide-border-left': 'no',
    'text-hide-border-right': 'no',
    'text-hide-border-top': 'no',
    'text-hide-border-bottom': 'no',
    'source-text-hide-border-left': 'no',
    'source-text-hide-border-right': 'no',
    'source-text-hide-border-top': 'no',
    'source-text-hide-border-bottom': 'no',
